...
class FreeAccessNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('24 часа доступа в пространстве LavandaKim ⏳')
            ->greeting('Здравствуйте, ' . $notifiable->name)
            ->line('Добро пожаловать на наш сайт!')
            ->line('Вам открыт доступ ко всем разделам LavandaKim на 24 часа.')
