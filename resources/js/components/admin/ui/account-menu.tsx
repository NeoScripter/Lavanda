...
const AccountMenu: FC<{ id: string; name: string; show: boolean }> = ({
    ...
    return (
        <div
            id={id}
            class={cn(
                'absolute bottom-13 left-0 z-10 [width:max(100%,14rem)] origin-bottom-right divide-y-1 divide-muted border border-muted bg-background shadow-sm transition-[opacity,scale] md:rounded-lg',
                {
        ...
        >
            <ul class="divide-y-1 divide-muted">
