...
export type AssymetricHeroSectionProps = {
    heading: string;
    description: string;
    fgImg: BgLoaderImg;
    decorImg: ComponentChild;
};

export type AssymetricIntroSectionProps = {
    heading: string;
    intros: string[];
};

const AssymetricLayout: FC<{
    headTitle: string;
    heroProps: AssymetricHeroSectionProps;
    introProps: AssymetricIntroSectionProps;
    children?: ComponentChild;
}> = ({ headTitle, heroProps, introProps, children }) => {
    return (
