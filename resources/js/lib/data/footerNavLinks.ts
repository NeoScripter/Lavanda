...
export const footerNavLinks: FooterNavLinkType[] = [
    ...
    },
    {
        ...
        title: 'Оферта',
        description:
            'Здесь можно ознакомиться с <a class="default-url" href="/legal/consent">условиями использования</a> и <a class="default-url" href="/legal/policy">политиками ресурса</a>.',
        url: '/legal/policy',
    },
];
