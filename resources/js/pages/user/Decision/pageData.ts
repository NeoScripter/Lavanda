...
export const heroDescription =
    'Когда трудно выбрать путь — остановитесь и послушайте себя. Здесь вы найдете поддержку, чтобы принять решение спокойно и уверенно.';
...
export const assymetricSectionLinks: AssymetricSectionLink[] = [
    ...
    },
    {
        ...
        description:
            'Это один из наиболее известных и почитаемых трудов китайской философии. Несмотря на исчитанность вдоль и поперек, она для каждого нового читателя открывает новые свои грани.',
        img: DecisionLink5,
