                    ...
                    <div className={css.right}>
                        <div>
                            ...
                            <p className={css.gameIntro}>
                                Начни с авторской колоды с котиками. Без сложных
                                раскладов и длинных объяснений - просто открой
                                карту и посмотри, что она расскажет о том,
                                почему именно сегодня ты здесь.
                            </p>
                        </div>
                        <PromoCards />
                    </div>
