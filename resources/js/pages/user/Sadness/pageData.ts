...
export const heroDescription =
    'Иногда всё, что нужно — немного поддержки и знак, что ты не одна. В этом разделе собраны разные способы найти опору, понять свои чувства и чуть-чуть отпустить тяжесть.';
