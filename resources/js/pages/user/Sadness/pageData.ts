...
export const introParts = [
    ...
    'В этом разделе можно найти маленькие опоры — слова, символы, знаки, которые напоминают: всё проходит, и внутри вас всё ещё есть свет.',
    ...
    'Попробуйте выбрать то, что откликается именно вам — руну, карту, гексаграмму или просто включите аудио. Возможно, именно сейчас вы услышите то, что поможет отпустить боль и сделать первый шаг к спокойствию.',
];
